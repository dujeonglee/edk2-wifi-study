...
TEST_F (WpaHmacMd5Test, Rfc2202Vector1)
{
  ...
  //
  // RFC 2202 Test Case 1 HMAC-MD5 expected value: 9294727a3638bb1c13f48ef8158bfc9d
  //
  UINT8  Expected[16] = {
...
TEST_F (WpaTkipCryptTest, EncryptDecryptRoundTrip)
{
  ...
  UINT8  Tk[32] = {
    ...
    0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88   // RX-MIC (same as TX-MIC for loopback test)
  };
